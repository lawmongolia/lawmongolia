  ...
  },
  {
    ...
    body: {
      ...
      mn: [
        ...
        "Шаардлагатай тохиолдолд хэлэлцээр хийх, эвлэрэх нөхцөл боловсруулах, нэхэмжлэл болон бусад баримт бичиг бэлтгэх, шүүхэд өмгөөлөгчөөр төлөөлөн оролцох үйлчилгээ үзүүлнэ.",
      ],
    },
    covers: {
      en: [
  ...
  },
  {
    ...
    body: {
      ...
      mn: [
        ...
        "Татварын акт, шийдвэрийг эс зөвшөөрөх болон татварын маргаанд захиргааны байгууллага, шүүхэд өмгөөлөгчөөр төлөөлөн оролцоно.",
      ],
    },
    covers: {
      en: [
  ...
  },
  {
    ...
    body: {
      ...
      mn: [
        ...
        "Мөн сахилгын шийтгэл, хөдөлмөрийн гэрээ дуусгавар болгох, бүтцийн өөрчлөлт болон хөдөлмөрийн маргаантай холбоотой асуудлаар зөвлөгөө өгч, шаардлагатай тохиолдолд шүүхэд өмгөөлөгчөөр төлөөлөн оролцоно.",
      ],
    },
    covers: {
      en: [
